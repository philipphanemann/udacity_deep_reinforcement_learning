...
### own solution
- average rewards for eps (index) and alpha (columns) can be found in 'param_calibration.csv'
- the learning spead of the parameters can be viewed in learning rates
